...
export default function SignIn() {
  ...
  const handleSocialLogin = async (provider: 'google' | 'apple' | 'facebook') => {
    if (provider !== 'google') return; // only Google implemented for now
    ...
    try {
      ...
      if (result.type === 'success' && result.url) {
        ...
        if (code) {
          ...
          // onAuthStateChange(SIGNED_IN) fires in AuthContext → routes to tabs
        }
      }
    } catch (err: any) {
          ...
          >
            {magicLinkSent ? (
              ...
              <>
                {/* Logo */}
                <Image
                  source={require('@/assets/images/white.svg')}
                  style={styles.logo}
                  contentFit="contain"
                />
                ...
                <View style={styles.signUpContainer}>
                  ...
                  <Pressable onPress={handleSignUp} accessibilityRole="button">
